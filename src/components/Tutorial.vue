<template>
  <div v-if="currentTutorial" class="edit-form mt-5">
    <h4>Tutorial</h4>
    <form>
    ...
    <button v-else class="btn btn-primary btn-sm mr-3" @click="updatePublished(true)">Publish</button>

    <button class="btn btn-danger btn-sm mr-3" @click="deleteTutorial">Delete</button>
